...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Procedure.url_height'
        db.add_column(u'article_procedure', 'url_height',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default='200', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Procedure.url_width'
        db.add_column(u'article_procedure', 'url_width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default='200', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Procedure.url_height'
        db.delete_column(u'article_procedure', 'url_height')

        # Deleting field 'Procedure.url_width'
        db.delete_column(u'article_procedure', 'url_width')
