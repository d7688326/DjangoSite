...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Procedure.description'
        db.alter_column(u'article_procedure', 'description', self.gf('django.db.models.fields.TextField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Procedure.description'
        db.alter_column(u'article_procedure', 'description', self.gf('django.db.models.fields.CharField')(max_length=300))
